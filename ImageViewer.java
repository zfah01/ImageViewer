...
public class ImageViewer
{
 ...
 //       makeFrame(); Made public and called in Driver to stop variable unused warning.
    ...
    /**
     * Makes the image flip vertically .
     */
 private void flip() { 
 ...
 /**
  * Makes the image rotate 90 degrees.
  */
 private void rotate(BufferedImage img) {  
	if(currentImage != null){
     int width = currentImage.getWidth();
     int height = currentImage.getHeight();
     OFImage rotatedImage = new OFImage(width, height);
 ...
 /**
  * Resets it to the original image.
  */
 private void reset() {
     OFImage reset = originalImage;
     currentImage = reset;
     imagePanel.setImage(currentImage);
    ...
    /**
     * Show the file name of the current image in the file's display label.
    ...
    public void makeFrame()
    {
        ...
        frame.getContentPane().add(scrollImage );  
    ...
    private void makeMenuBar(JFrame frame)
    {
     ...
     // create the options menu
        ...
        item = new JMenuItem("Flip");
            ...
            item.addActionListener(new ActionListener() {
                               public void actionPerformed(ActionEvent e) { flip(); }
                           });
        menu.add(item);
        menu.addSeparator();
        ...
        item.addActionListener(new ActionListener() {
                           public void actionPerformed(ActionEvent e) { rotate(currentImage); }
                       });
        menu.add(item);
        menu.addSeparator();
